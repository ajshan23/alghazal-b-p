...
exports.getLPOsByProject = exports.deleteLPO = exports.getLPODetails = exports.createLPO = void 0;
...
exports.createLPO = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    const lpo = await lpoModel_1.LPO.create({
        project: projectId,
        lpoNumber: await (0, documentNumbers_1.generateRelatedDocumentNumber)(projectId, "LPO"),
