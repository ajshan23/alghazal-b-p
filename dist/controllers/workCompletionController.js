...
exports.generateCompletionCertificatePdf = exports.getCompletionData = exports.getProjectWorkCompletionImages = exports.deleteWorkCompletionImage = exports.getWorkCompletion = exports.uploadWorkCompletionImages = exports.createWorkCompletion = void 0;
...
exports.uploadWorkCompletionImages = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    res
        .status(200)
        .json(new apiHandlerHelpers_1.ApiResponse(200, workCompletion, "Images uploaded successfully"));
});
exports.getWorkCompletion = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    res
        .status(200)
        .json(new apiHandlerHelpers_1.ApiResponse(200, workCompletion, "Work completion retrieved successfully"));
});
exports.deleteWorkCompletionImage = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    res
        .status(200)
        .json(new apiHandlerHelpers_1.ApiResponse(200, workCompletion, "Image deleted successfully"));
});
...
exports.getCompletionData = (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    res
        .status(200)
        .json(new apiHandlerHelpers_1.ApiResponse(200, responseData, "Completion data retrieved successfully"));
});
    ...
    <body>
        <div class="container">
            ...
            <table>
                <tr>
                    ...
                    <td>: <span class="highlight">${formatDate(workCompletion?.createdAt)}</span></td>
                </tr>
                <tr>
        ...
        : "(signature)"}
                ...
                <tr>
                    ...
                    <td><span class="green-text">${formatDate(workCompletion?.createdAt)}</span></td>
                    <td></td>
                    <td></td>
                </tr>
            </table>
